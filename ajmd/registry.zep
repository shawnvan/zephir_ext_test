...
final class Registry implements \ArrayAccess, \Countable, \Iterator
{
	 ...
	 */
	public final function offsetExists(offset) -> boolean
	{
	 ...
	 */
	public final function offsetGet(offset) -> var
	{
	 ...
	 */
	public final function offsetSet(offset, var value) -> void
	{
	 ...
	 * Sets an element in the registry
	 */
	public final function __set( key, var value) -> void
	{
	 ...
	 * Returns an index in the registry
	 */
	public final function __get( key) -> var
	{
		return this->offsetGet(key);
	}

	public final function __isset( key) -> boolean
	{
